...
public class Main {
    public static void main(String[] args) {
        ...
        // Consultar disponibilidad en el hotel entre el 14 y 20 de junio de 2024 (después de las reservas)
        hotel.consultarDisponibilidad(LocalDate.of(2024, 6, 14), LocalDate.of(2024, 6, 20));
        ...
        // Reservar habitación para Maria
        ...
        // Mostrar información detallada de las reservas del hotel
